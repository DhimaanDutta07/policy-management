...
export enum TemplateType {
  ...
  REOPENED_FOR_DELIVERY = 'reopened_for_delivery',
...
export class WhatsAppService {
  private apiUrl: string = 'https://api.interakt.ai/v1/public/message/';
   ...
   */
  private prepareBodyValues(templateType: TemplateType, variables: any): string[] {
    switch (templateType) {
