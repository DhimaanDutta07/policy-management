...
exports.validateBulkPolicies = validateBulkPolicies;
const dynamicFieldMapper_1 = require("../utils/dynamicFieldMapper");
// Validate an array of policy records for bulk import using dynamic mapping and validation
async function validateBulkPolicies(records) {
    ...
    for (let i = 0; i < records.length; i++) {
        ...
        try {
            ...
            mappedRow = (0, dynamicFieldMapper_1.mapExcelFieldsWithDynamicMembers)(originalRow);
        ...
        try {
            ...
            transformedRow = (0, dynamicFieldMapper_1.transformExcelData)(mappedRow);
        ...
        const validationResult = (0, dynamicFieldMapper_1.validateComprehensiveRecord)(transformedRow);
