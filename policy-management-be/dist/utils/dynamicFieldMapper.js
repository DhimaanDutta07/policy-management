...
exports.ComprehensiveImportSchema = void 0;
exports.mapExcelFieldsWithDynamicMembers = mapExcelFieldsWithDynamicMembers;
exports.transformExcelData = transformExcelData;
exports.validateComprehensiveRecord = validateComprehensiveRecord;
...
function calculateGSTExclusiveAmount(amountIncludingGST) {
...
function calculateGSTAmount(amountIncludingGST) {
    if (!amountIncludingGST || amountIncludingGST <= 0) {
        return 0;
    }
...
const transformInsuranceType = (value) => {
    const typeMapping = {
...
const transformMaritalStatus = (value) => {
    const statusMapping = {
        'Single': 'Single',
        'Married': 'Married',
        'Divorced': 'Divorced',
...
function mapExcelFieldsWithDynamicMembers(record) {
    const result = {
        proposer: {},
        insured_members: [],
        nominee_payment: {},
    ...
    result.insured_members = result.insured_members.filter((insured_member) => insured_member && Object.keys(insured_member).length > 0 &&
...
function transformExcelData(record) {
    ...
    if (transformed.insured_members && Array.isArray(transformed.insured_members)) {
        transformed.insured_members.forEach((insured_member) => {
        ...
        transformed.insured_members = transformed.insured_members.filter((member) => {
            if (!member)
                return false;
    ...
    if (!transformed.customer_name || transformed.customer_name === '') {
        if (transformed.proposer && transformed.proposer.full_name) {
            ...
            const selfMember = transformed.insured_members.find((m) => (m?.relation_to_proposer || '').toLowerCase() === 'self' && m?.name && String(m.name).trim() !== '');
            const firstNamedMember = transformed.insured_members.find((m) => m?.name && String(m.name).trim() !== '');
...
exports.ComprehensiveImportSchema = zod_1.z.object({
    // Policy fields
    policy_number: zod_1.z.string().min(1, "Policy number is required"),
    customer_name: zod_1.z.string().min(1, "Customer name is required"),
    type: zod_1.z.string().default('HEALTH INSURANCE'),
    ...
    sum_insured: zod_1.z.number().positive().optional(),
    start_date: zod_1.z.union([zod_1.z.string().datetime(), zod_1.z.number()]).optional(),
    end_date: zod_1.z.union([zod_1.z.string().datetime(), zod_1.z.number()]).optional(),
    tenure_years: zod_1.z.number().positive().optional(),
    // issued_date: z.string().datetime("Issued date must be a valid date"),
    premium_amount: zod_1.z.number().positive().optional(),
    premium_amount_gst: zod_1.z.number().positive().optional(),
    gst_status: zod_1.z.boolean().optional(),
    declaration_accepted: zod_1.z.boolean().default(true),
    ...
    policy_creation_status: zod_1.z.enum(['Fresh', 'Renewal', 'Migration', 'Portablity']).optional(),
    ...
    policy_type_name: zod_1.z.string().nullable().optional(),
    policy_name_name: zod_1.z.string().nullable().optional(),
    policy_group_name: zod_1.z.string().nullable().optional(),
    policy_salutation: zod_1.z.string().optional(),
    // Proposer
    proposer: zod_1.z.object({
        full_name: zod_1.z.string().optional(),
        proposer_salutation: zod_1.z.string().optional(),
        date_of_birth: zod_1.z.union([zod_1.z.string().datetime(), zod_1.z.number()]).optional(),
        gender: zod_1.z.enum(['Male', 'Female', 'Other']).optional(),
        marital_status: zod_1.z.enum(['Single', 'Married', 'Divorced', 'Widowed']).optional(),
        mobile: zod_1.z.union([zod_1.z.string(), zod_1.z.number()]).optional(),
        alternate_mobile: zod_1.z.union([zod_1.z.string(), zod_1.z.number()]).optional(),
        email: zod_1.z.string().email().optional(),
        address: zod_1.z.string().optional(),
        kyc_id: zod_1.z.string().optional(),
    ...
    insured_members: zod_1.z.array(zod_1.z.object({
        ...
        insured_member_salutation: zod_1.z.string().optional(),
        relation_to_proposer: zod_1.z.string().optional(),
        date_of_birth: zod_1.z.union([zod_1.z.string().datetime(), zod_1.z.number()]).optional(),
        gender: zod_1.z.enum(['Male', 'Female', 'Other']).optional(),
        pre_existing: zod_1.z.boolean().optional(),
        insured_member_medical_condition: zod_1.z.boolean().optional(),
        insured_member_medical_remarks: zod_1.z.string().optional(),
    ...
    // Nominee
    nominee_payment: zod_1.z.object({
        nominee_name: zod_1.z.string().optional(),
        nominee_salutation: zod_1.z.string().optional(),
        nominee_relation: zod_1.z.string().optional(),
        nominee_dob: zod_1.z.union([zod_1.z.string().datetime(), zod_1.z.number()]).optional(),
        ...
        bank_ifsc_code: zod_1.z.string().optional(),
        bank_branch_name: zod_1.z.string().optional(),
    }).optional(),
    // Form values
    form_values: zod_1.z.array(zod_1.z.object({
        field_name: zod_1.z.string(),
        value: zod_1.z.string(),
    })).optional(),
});
function validateComprehensiveRecord(record) {
    try {
        ...
        if (processedRecord.insured_members && Array.isArray(processedRecord.insured_members)) {
            processedRecord.insured_members.forEach((member) => {
        ...
        return exports.ComprehensiveImportSchema.safeParse(processedRecord);
    }
    catch (error) {
